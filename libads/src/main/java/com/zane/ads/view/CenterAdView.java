...
public class CenterAdView implements View.OnClickListener{
    ...
    public CenterAdView(Context context, ADData adItem, Object o) {
    ...
    private void initView() {
        rootView = LayoutInflater.from(context).inflate(R.layout.ad_center_view, null);
        ...
        rootView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (o instanceof NativeADDataRef) {
                    IflyAdManager.getInstance(context).onAdTouchListener(event, BaseADManager.ID_QT_NATIVE);
                }
                return false;
            }
        });
